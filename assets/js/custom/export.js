            ...
            <script>
                ...
                function applyHeaderVisibility() {
                    ...
                    if (fileName === "" || fileName === "index" || fileName === "home") {
                        ...
                        $("#header .main-header-section").show();
                        $("#header .header-breadcrumb-section").hide();

                    } else {

                        $("#header .main-header-section").hide();
                        $("#header .header-breadcrumb-section").show();

                        $("#header .header-breadcrumb-section .Page_name")
